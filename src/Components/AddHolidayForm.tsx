//- Build a form for the app that allows the user to create items with specific data.
...
export default function AddHolidayForm({ onSubmit }: AddHolidayFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Enter the local name for the holiday:
        <input
          type="text"
          name="localName"
      ...
      <label>
        Enter the name for the holiday:
        <input
          type="text"
          name="name"
          value={inputs.name}
      ...
      <label>
        Enter the country where the holiday is celebrated:
        <input
          type="text"
          name="countryCode"
